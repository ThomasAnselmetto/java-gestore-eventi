...
//        ● titolo: String
//        ● eventi: List<Evento> Nel costruttore valorizzare il titolo, passato come parametro, e inizializzare la lista di eventi come una nuova ArrayList
//        Aggiungere i seguenti metodi :
//        ● un metodo che aggiunge alla lista un Evento, passato come parametro
//        ● un metodo che restituisce una lista con tutti gli eventi presenti in una certa data
//        ● un metodo che restituisce quanti eventi sono presenti nel programma
//        ● un metodo che svuota la lista di eventi
//        ● un metodo che restituisce una stringa che mostra il titolo del programma e tutti gli eventi nella forma:
//        ○ data1 - titolo1
//        ○ data2 - titolo2
//        ○ data3 - titolo3
//        ○ … (edited)
